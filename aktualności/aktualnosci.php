...
<body class="animsition">
	...
	<section>
		...
		<div class="container m-l-r-auto" style="width: 90%;">
			<div class="row">
				<div class="" style="width: 70%; float:left">
					<div class="p-t-80 p-b-124 bo5-r h-full p-r-50 p-r-0-md bo-none-md">
                        <form method="post" action="aktualnosc.php">
                            <!-- Bloki -->
                            <?php
								...
								if ($szuk != "") {
									$pytanie="SELECT temat, DATE_FORMAT(data,'%d/%m/%Y'), autor, zdjecie, id, tekst FROM `aktualnosci` WHERE `temat` LIKE '%".$szuk."%' ORDER BY ID DESC;";
								}
								else {
									$pytanie="SELECT temat, DATE_FORMAT(data,'%d/%m/%Y'), autor, zdjecie, id, tekst FROM `aktualnosci` ORDER BY ID DESC;";
								}
                                ...
                                for ($i=0;$i<$ilosc;$i++) {
                                    ...
                                    echo '
									<button class="m-l-20 m-r-20 m-b-30 aktualnoscwidth1" type="submit" name="submit" value="'.$wynik1[4].'">
										<figure class="card">
				...
				<div class="" style="width: 30%; float:left">
					<div class="sidebar2 p-t-80 p-b-80 p-l-20 p-l-0-md p-t-0-md">
						<!-- Szukajka -->
						<form method="post" action="aktualnoscisearch.php">
							<div class="search-sidebar2 size12 bo2 pos-relative">
								<input class="input-search-sidebar2 txt10 p-l-20 p-r-55" type="text" name="search" placeholder="Wyszukaj">
